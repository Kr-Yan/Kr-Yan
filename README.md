...
- **[Fake News Lab: Analyzing Covid-19 Myths](https://github.com/Kr-Yan/Fake-News-Lab-Analyzing-Covid-19-Myths)**: This project analyzes the most discussed topics and keywords surrounding Covid-19 news using ML techniques. We employed Latent Dirichlet Allocation (LDA) and text summarization methods to extract key insights from a dataset of Covid-19 related discussions.
